const orderActionTypes = {
  ...
  OPEN_ORDER_STATUS_CLEAR: 'OPEN_ORDER_STATUS_CLEAR',

  EX_RATE_REQUEST: 'EX_RATE_REQUEST',
  EX_RATE_SUCCESS: 'EX_RATE_SUCCESS',
  EX_RATE_FAIL: 'EX_RATE_FAIL',
  EX_RATE_STATUS_CLEAR: 'EX_RATE_STATUS_CLEAR',
